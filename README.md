...
## Getting Started
1. **Get API Key**
   - Subscribe via your preferred marketplace: [API.Market](https://api.market/store/osint-trace-1/amazon-checker) or [RapidAPI Hub](https://rapidapi.com/osint-org-osint-org-default/api/amazon-checker)
...
## Pricing
Flexible plans available through [API.Market](https://api.market/store/osint-trace-1/amazon-checker) or [RapidAPI](https://rapidapi.com/osint-org-osint-org-default/api/amazon-checker/pricing).   
